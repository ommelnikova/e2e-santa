...
#делаем ниже таблицу из верхней строки и получается подбор по массиву в тесте
...
#  возвращаем верхнюю строчку кот делали до этого внося некоторые изменения и прорабатываем Examples добавляя внизу
#When user logs in as "<login>" and "<password>" это для прогона всех юзеров
...
#| gromova_student+test2@eicb.ru | Qwerty123! |
#| gromova_student+test3@eicb.ru | Qwerty123! |
#выше могу ли лог со всеми юзерами